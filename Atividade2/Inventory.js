    ...
    addItem(item, quantity) {
        if (this.items[item]) {
            ...
            if (newQuantity > this.MAX_QUANTITY) {
                console.log(`Quantidade excede o limite de ${this.MAX_QUANTITY}. Ajustado para o máximo permitido.`);
            ...
            if (quantity > this.MAX_QUANTITY) {
                console.log(`Quantidade inicial excede o limite de ${this.MAX_QUANTITY}. Adicionado apenas ${this.MAX_QUANTITY}.`);
                this.items[item] = this.MAX_QUANTITY;
            }
            else {
                this.items[item] = quantity;
